...
#ifndef DARWINN_DRIVER_KERNEL_LINUX_KERNEL_COHERENT_ALLOCATOR_LINUX_H_
#define DARWINN_DRIVER_KERNEL_LINUX_KERNEL_COHERENT_ALLOCATOR_LINUX_H_
...
class KernelCoherentAllocatorLinux : public KernelCoherentAllocator {
 public:
  KernelCoherentAllocatorLinux(const std::string &device_path,
...
#endif  // DARWINN_DRIVER_KERNEL_LINUX_KERNEL_COHERENT_ALLOCATOR_LINUX_H_
