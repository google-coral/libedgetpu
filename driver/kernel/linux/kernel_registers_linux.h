...
#ifndef DARWINN_DRIVER_KERNEL_LINUX_KERNEL_REGISTERS_LINUX_H_
#define DARWINN_DRIVER_KERNEL_LINUX_KERNEL_REGISTERS_LINUX_H_
...
class KernelRegistersLinux : public KernelRegisters {
 public:
  KernelRegistersLinux(const std::string& device_path,
                       const std::vector<MmapRegion>& mmap_region,
                       bool read_only);

  KernelRegistersLinux(const std::string& device_path, uint64 mmap_offset,
...
#endif  // DARWINN_DRIVER_KERNEL_LINUX_KERNEL_REGISTERS_LINUX_H_
