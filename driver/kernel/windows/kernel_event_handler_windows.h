...
#ifndef DARWINN_DRIVER_KERNEL_WINDOWS_KERNEL_EVENT_HANDLER_WINDOWS_H_
#define DARWINN_DRIVER_KERNEL_WINDOWS_KERNEL_EVENT_HANDLER_WINDOWS_H_
...
class KernelEventHandlerWindows : public KernelEventHandler {
 public:
  KernelEventHandlerWindows(const std::string& device_path, int num_events);
...
#endif  // DARWINN_DRIVER_KERNEL_WINDOWS_KERNEL_EVENT_HANDLER_WINDOWS_H_
