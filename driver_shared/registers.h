...
class Registers {
 public:
  ...
  virtual Status Write32(uint64 offset, uint32 value) = 0;
  virtual StatusOr<uint32> Read32(uint64 offset) = 0;
  virtual Status Poll32(uint64 offset, uint32 expected_value,
                        int64 timeout_ns = 0) = 0;
};
