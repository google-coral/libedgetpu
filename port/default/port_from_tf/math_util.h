...
#ifndef DARWINN_PORT_DEFAULT_PORT_FROM_TF_MATH_UTIL_H_
#define DARWINN_PORT_DEFAULT_PORT_FROM_TF_MATH_UTIL_H_
...
IntegralType MathUtil::CeilOrFloorOfRatio(IntegralType numerator,
  ...
  static_assert(std::is_integral<IntegralType>::value,
                "CeilOrFloorOfRatio is only defined for integral types.");
  DCHECK_NE(0, denominator) << "Division by zero is not supported.";
  DCHECK(!std::is_signed<IntegralType>::value ||
...
#endif  // DARWINN_PORT_DEFAULT_PORT_FROM_TF_MATH_UTIL_H_
