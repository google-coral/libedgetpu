...
#ifndef DARWINN_PORT_DEFAULT_PORT_FROM_TF_STATUSOR_INTERNALS_H_
#define DARWINN_PORT_DEFAULT_PORT_FROM_TF_STATUSOR_INTERNALS_H_

#include "port/default/port_from_tf/macros.h"
#include "port/default/port_from_tf/status.h"
#include "port/default/unreachable.h"
...
class Helper {
 public:
  ...
  ATTRIBUTE_NORETURN static void Crash(const Status& status);
};
...
#endif  // DARWINN_PORT_DEFAULT_PORT_FROM_TF_STATUSOR_INTERNALS_H_
