...
#ifndef DARWINN_PORT_DEFAULT_PORT_FROM_TF_THREAD_ANNOTATIONS_H_
#define DARWINN_PORT_DEFAULT_PORT_FROM_TF_THREAD_ANNOTATIONS_H_
...
#endif  // DARWINN_PORT_DEFAULT_PORT_FROM_TF_THREAD_ANNOTATIONS_H_
